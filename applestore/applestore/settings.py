...
SECRET_KEY = 'django-insecure-lgxa(q-oc4@z7%sdcf*a6ie#i^)(12+a45!q67g_v4uu+8a2dl'
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': 'your-secret-key',  # Use Django's SECRET_KEY or environment variable for security
